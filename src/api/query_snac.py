...
CACHE_DIR = Path("src/data/snac_cache")

ASPACE_ERROR_CSV       = "logs/aspace_query_errors.csv"
SNAC_QUERY_ERROR_LOG   = "logs/snac_query_errors.log"
SNAC_NOT_FOUND_LOG     = "logs/snac_query_not_found.log"
SNAC_ID_CHANGES_LOG    = "logs/snac_id_changes.log"
